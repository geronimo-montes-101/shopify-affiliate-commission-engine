	...
	return (
		<s-page heading="Affiliate & Commission Engine">
			<s-section heading="Dashboard">
				...
				>
					...
					>
						...
						<s-paragraph>
							${metricas.totalVentasReferidas.toFixed(2)}
						</s-paragraph>
					...
					>
						...
						<s-paragraph>
							${metricas.totalComisionAfiliados.toFixed(2)}
						</s-paragraph>
					</div>
					<div
						style={{
			...
			<s-section heading="Estado del MVP">
				<s-paragraph>
					Ya tenemos autenticacion embedded, sesiones Shopify, campanas y panel
					base para afiliados y metricas.
				</s-paragraph>
			</s-section>
			...
			<s-section heading="Siguientes modulos">
				<s-unordered-list>
					<s-list-item>
						Captura de `ref` y persistencia client-side.
					</s-list-item>
